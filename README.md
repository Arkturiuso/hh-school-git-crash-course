...
Чтобы его найти, нужно внимательно посмотреть на историю коммитов этого тега. Она длинная и выглядит бессмысленно.
Но в ней есть ключи, которые помогут найти **потерянный** коммит, просто нужно оставить только **значимое**.

!ВАЖНО! Коммиты без ссылок не добавляются в локальный репозиторий, искать стоит на github.
